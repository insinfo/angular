...
// in ngx_router/test/regression/hash_location_strategy_test.dart.
...
import 'package:ngx_router/src/location/platform_location.dart' as _i2;
...
class MockPlatformLocation extends _i1.Mock implements _i2.PlatformLocation {
  ...
  @override
  void onPopState(void Function(_i4.Event)? fn) => super.noSuchMethod(
        Invocation.method(
          #onPopState,
          [fn],
        ),
  ...
  @override
  void onHashChange(void Function(_i4.Event)? fn) => super.noSuchMethod(
        Invocation.method(
          #onHashChange,
          [fn],
        ),
