...
const _angularRootUrl = 'package:ng_core/angular.dart';
const _angularLib = 'asset:ng_core/lib';
...
class Identifiers {
  ...
  static final viewContainerRef = CompileIdentifierMetadata(
      ...
      moduleUrl: 'asset:ng_core/lib/src/core/linker/view_container_ref.dart');
  ...
  static final componentLoader = CompileIdentifierMetadata(
      ...
      moduleUrl: 'asset:ng_core/lib/src/core/linker/component_loader.dart');
  ...
  static final changeDetectorRef = CompileIdentifierMetadata(
      ...
      moduleUrl: 'asset:ng_core/lib/src/core/change_detection/'
  ...
  static final directiveChangeDetector = CompileIdentifierMetadata(
      ...
      moduleUrl: 'asset:ng_core/lib/src/core/'
