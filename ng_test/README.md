[![Pub package](https://img.shields.io/pub/v/ng_test.svg)](https://pub.dev/packages/ng_test)
...
[pub_ng_test]: https://pub.dev/packages/ng_test
...
[webdev_angular]: https://pub.dev/packages/ng_core
...
`ng_test` is a library for writing tests for AngularDart components.
...
To use `ng_test`, configure your package's `pubspec.yaml` as follows:
...
**IMPORTANT**: `ng_test` will not run without these dependencies set.
