...
import 'package:ngx_ast/ngx_ast.dart' as ast;
import 'package:ngx_compiler/v1/cli.dart';
import 'package:ngx_compiler/v1/src/compiler/chars.dart';
...
import 'package:ngx_compiler/v1/src/compiler/html_tags.dart';
import 'package:ngx_compiler/v1/src/compiler/i18n.dart';
import 'package:ngx_compiler/v1/src/compiler/i18n/property_visitor.dart';
import 'package:ngx_compiler/v1/src/compiler/identifiers.dart';
import 'package:ngx_compiler/v1/src/compiler/parse_util.dart';
import 'package:ngx_compiler/v1/src/compiler/provider_parser.dart';
import 'package:ngx_compiler/v1/src/compiler/schema/element_schema_registry.dart';
import 'package:ngx_compiler/v1/src/compiler/selector.dart';
import 'package:ngx_compiler/v1/src/compiler/style_url_resolver.dart';
import 'package:ngx_compiler/v1/src/compiler/template_ast.dart' as ng;
import 'package:ngx_compiler/v1/src/compiler/template_optimize.dart';
import 'package:ngx_compiler/v1/src/compiler/template_parser.dart';
...
/// A [TemplateParser] which uses the `ngx_ast` package to parse angular
/// templates.
class AstTemplateParser {
  ...
  /// 1. Parse the raw template using `ngx_ast` package.
  ...
  List<ng.TemplateAst> parse(
    ...
    // This is a specific error handler that we pass to ngx_ast that in turn
    // uses mechanics similar to CompileContext; it is intentionally separate in
    // order ot avoid a dependency on ngx_compiler from ngx_ast.
...
///
/// This visitor also converts from the pkg:ngx_ast types to the angular
...
// TODO(alorenzen): Refactor this into pkg:ngx_ast.
