...
import 'package:ngx_compiler/v1/src/compiler/ir/model.dart';
...
import 'package:ngx_compiler/v1/src/compiler/view_compiler/compile_view.dart'
  ...
  o.Statement visitStyleBinding(ir.StyleBinding styleBinding, [_]) {
    ...
    if (styleBinding.unit != null) {
      ...
      if (bindingSource.isNullable) {
        // package:web's CssStyleDeclaration.setProperty() takes a non-nullable
        // String, unlike dart:html which accepted null. An empty string removes
        // the property, which is what null did.
